...
Original file is located at
    https://colab.research.google.com/drive/1EDVCtAcj973a0fjq613ZqsbfVoQV5mYA
"""
...
train_transform = transforms.Compose([
    transforms.Resize(size=(448,448), interpolation=transforms.InterpolationMode.BILINEAR),  # BILINEAR로 변경
...
for fold_idx, (train_index, val_index) in enumerate(skf.split(train_df, train_df['class'])):
    ...
    checkpoint_callback = ModelCheckpoint(
        ...
        filename=f'eva02-base-fold_idx={fold_idx}'+'-{epoch:02d}-{train_loss:.4f}-{val_loss:.4f}-{val_score:.4f}',
        save_top_k=1,
...
fold_preds = []
for checkpoint_path in glob('/content/drive/MyDrive/checkpoints/eva02-base*.ckpt'):
    model = timm.create_model('eva02_base_patch14_448.mim_in22k_ft_in1k', pretrained=True)
...
submission.to_csv('/content/drive/MyDrive/data/eva02_base_patch14_448.mim_in22k_ft_in1k.csv',index=False)