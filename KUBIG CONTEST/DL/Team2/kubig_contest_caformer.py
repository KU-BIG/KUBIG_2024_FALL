# -*- coding: utf-8 -*-
"""Kubig_contest_caformer.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1XhMXZbnSqztQMN2hdN_gHe2Ro7-RAy7k
"""
...
for fold_idx, (train_index, val_index) in enumerate(skf.split(train_df, train_df['class'])):
    ...
    model = timm.create_model('caformer_b36.sail_in22k_ft_in1k', pretrained = True)
    ...
    checkpoint_callback = ModelCheckpoint(
        ...
        filename=f'caformer-b36-fold_idx={fold_idx}'+'-{epoch:02d}-{train_loss:.4f}-{val_loss:.4f}-{val_score:.4f}',
        save_top_k=1,
...
fold_preds = []
for checkpoint_path in glob('/content/drive/MyDrive/checkpoints/caformer-b36*.ckpt'):
    model = timm.create_model('caformer_b36.sail_in22k_ft_in1k', pretrained=True)
...
submission.to_csv('/content/drive/MyDrive/data/caformer_b36.sail_in22k_ft_in1k.csv',index=False)
