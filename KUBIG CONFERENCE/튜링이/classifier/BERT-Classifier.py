...
# -*- coding: utf-8 -*-
"""
Refactored BERT Classifier Code
"""
...
def load_data_from_files(file_names, file_path_template):
    """Loads data from a list of JSON files and returns a dictionary"""
    data_dict = {}
...
if __name__ == "__main__":
    print("Loading data...")
    data = load_data_from_files(LIST_OF_NAMES, FILE_PATH_TEMPLATE)
    
    # Display loaded keys
    if data:
        print("Data successfully loaded! Keys:")
        print(data.keys())
    else:
        print("No data was loaded. Please check the file paths and names.")
...
plt.title('KDE Plot for Sampled Crit')
plt.xlabel('Value')
plt.ylabel('Density')
...
plt.title('KDE Plot for Original Crit')
plt.xlabel('Value')
plt.ylabel('Density')
...
# 왼쪽 값 KDE 플롯
sns.kdeplot(left_values, shade=True, label='Sampled(paraphrased)', color='orange')

# 오른쪽 값 KDE 플롯
sns.kdeplot(right_values, shade=True, label='Original', color='blue')

# 제목 및 레이블 추가
plt.title('KDE Plot of Original Crit and Sampled Crit (Paraphrased)')
plt.xlabel('Value')
plt.ylabel('Density')
...
# 왼쪽 값 KDE 플롯
sns.kdeplot(left_values, shade=True, label='Sampled(generated)', color='orange')

# 오른쪽 값 KDE 플롯
sns.kdeplot(right_values, shade=True, label='Original', color='blue')

# 제목 및 레이블 추가
plt.title('KDE Plot of Original Crit and Sampled Crit (Generated)')
plt.xlabel('Value')
plt.ylabel('Density')
